...
function doPll(name, auf) {
    var el = document.getElementById("solution");
    el.innerHTML = lastPll;
    pllAlg = pllsData.find(item => item[0] === name)[1]
    doMoves(auf + " " + pllAlg)
}
...
var pllsData  = [
    ...
    ["Ja", "x R2 F R F' R U2 r' U r U2 x'", 4],
...
var ollData  = [
    ["R Square", "r U2 R' U' R U' r'", 1],
    ["L Square", "l' U2 L U L' U l", 1],
];
